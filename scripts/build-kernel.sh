...
print(entry.get("kernelsu_setup", ""))
print(entry.get("kernelsu_repo", ""))
print(entry.get("kernelsu_ref", ""))
print(entry.get("kernelsu_susfs_patch", "true"))
PY
)
...
CORESHIFT_KERNELSU_SETUP_VALUE="${variant_fields[3]:-}"
CORESHIFT_KERNELSU_REPO_VALUE="${variant_fields[4]:-}"
CORESHIFT_KERNELSU_REF_VALUE="${variant_fields[5]:-}"
CORESHIFT_KERNELSU_SUSFS_PATCH_VALUE="${variant_fields[6]:-true}"
...
export CORESHIFT_KERNELSU_SETUP="$CORESHIFT_KERNELSU_SETUP_VALUE"
export CORESHIFT_KERNELSU_SUSFS_PATCH="$CORESHIFT_KERNELSU_SUSFS_PATCH_VALUE"

for reserved_variant_key in CORESHIFT_VARIANT CORESHIFT_FEATURES CORESHIFT_AK3_SUFFIXES CORESHIFT_KERNELSU_SETUP CORESHIFT_KERNELSU_SUSFS_PATCH; do
...
BUILD_ENV+=("CORESHIFT_KERNELSU_SETUP=$CORESHIFT_KERNELSU_SETUP_VALUE")
BUILD_ENV_KEYS+=("CORESHIFT_KERNELSU_SETUP")
DEFAULT_BUILD_ENV_KEYS+=("CORESHIFT_KERNELSU_SETUP")
BUILD_ENV+=("CORESHIFT_KERNELSU_SUSFS_PATCH=$CORESHIFT_KERNELSU_SUSFS_PATCH_VALUE")
BUILD_ENV_KEYS+=("CORESHIFT_KERNELSU_SUSFS_PATCH")
DEFAULT_BUILD_ENV_KEYS+=("CORESHIFT_KERNELSU_SUSFS_PATCH")
if [ -n "$CORESHIFT_KERNELSU_REPO_VALUE" ]; then
  add_default_build_env "KSU_REPO" "$CORESHIFT_KERNELSU_REPO_VALUE"
fi
if [ -n "$CORESHIFT_KERNELSU_REF_VALUE" ]; then
  add_default_build_env "KSU_REF" "$CORESHIFT_KERNELSU_REF_VALUE"
fi
